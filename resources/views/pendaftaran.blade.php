...
@section('container')
<form method="POST" action="/pendaftaran" class="row g-1 form-container">
    <h2>Pendaftaran</h2>
    
    <form method="POST" action="/pendaftaran" class="row g-3">
        @csrf
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="form-control @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin" name="jenis_kelamin" required value="{{ old('jenis_kelamin') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="form-control @error('agama') is-invalid @enderror" id="agama" name="agama" required value="{{ old('agama') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="form-control @error('jenis_kartu_atm') is-invalid @enderror" id="jenis_kartu_atm" name="jenis_kartu_atm" required value="{{ old('jenis_kartu_atm') }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('no_rek') is-invalid @enderror" id="no_rek" name="no_rek" required value="{{ old('no_rek') }}">
            @error('no_rek')
                 <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
